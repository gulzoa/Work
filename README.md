...
Small, focused portfolio containing selected projects and demos.
...
## How to run locally
Example for a CMake-based project:


```bash
# clone
git clone https://github.com/<username>/Work.git
cd Work/projects/01-embedded-blinky
mkdir build && cd build
cmake .. && make

Self Created and managed Code

Follow me on LinkedIn: www.linkedin.com/comm/mynetwork/discovery-see-all?usecase=PEOPLE_FOLLOWS&followMember=gulzaib-khan-44bb6620a
<a class="libutton" href="https://www.linkedin.com/comm/mynetwork/discovery-see-all?usecase=PEOPLE_FOLLOWS&followMember=gulzaib-khan-44bb6620a" target="_blank">Follow on LinkedIn</a>
